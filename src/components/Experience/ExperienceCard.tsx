...
const ExperienceCard: React.FC<ExperienceCardProps> = ({ data, locale }) => {
    ...
    <div className="bg-secondary border-border rounded-[14px] border p-5 md:p-6">
      ...
      <div className="flex flex-col gap-1">
        <div className="flex flex-col justify-between gap-1 sm:flex-row sm:items-center">
          <h3 className="text-neutral text-lg font-semibold">{company[isSpanish ? 'es' : 'en']}</h3>
